...
@section('pageName')Результаты опросов по шаблону "{{ $template->name }}"@endsection

@section('pageStyle')
    <link rel="stylesheet" href="{{ assetVersioned('dist/css/pages/manager/quiz/template/show.css') }}">
@endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <h1 class="mt-0">Результаты опросов по шаблону "{{ $template->name }}"</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('manager.quiz.template.results_index') }}">Результаты опросов</a></li>
                    <li class="breadcrumb-item active">Результаты опросов по шаблону "{{ $template->name }}"</li>
                </ol>
            </div><!-- /.container-fluid -->
        </div>
        <!-- /.content-header -->
        ...
        <section class="content">
            <div class="container-fluid pb-5">
                <div class="card card-primary">
                    <div class="card-body">
                        В опросе приняли участие <a href="javascript:void(0);" data-toggle="modal" data-target="#modal_client_list">{{ $template->clients_completed->count() }} из {{ $template->clients->count() }} заказчиков</a>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach ($template->clients as $survey_client)
