...
class MailTechDocUpdated extends Notification implements ShouldQueue
{
    use Queueable;
    public array $data;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Изменён технический документ: ' . $this->data['client_address'])
            ->line('Изменён документ в разделе технической документации.')
            ...
            ->line('Изменил: ' . $this->data['updated_name'])
