...
class MailTechDocDeleted extends Notification implements ShouldQueue
{
    use Queueable;
    public array $data;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Удалён технический документ: ' . $this->data['client_address'])
            ->line('Удалён документ из раздела технической документации.')
