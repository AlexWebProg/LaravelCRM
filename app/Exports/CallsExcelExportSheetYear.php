...
class CallsExcelExportSheetYear implements FromArray,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $workSheet->getStyle('A1:I1')->getAlignment()->setHorizontal('center');
                $workSheet->getStyle('A:I')->getAlignment()->setVertical('center');
                ...
                $workSheet->getStyle('A' . $event->sheet->getHighestRow() . ':I'. $event->sheet->getHighestRow())->applyFromArray([
                    'font' => ['bold' => true]
                ]);
